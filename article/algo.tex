...
In this example, a simple solution is expressed by linear expression
...
By naturally encoding every Horn clause with Farkas's lemma
constraints, we obtain the following linear constraint over
$c_i$.

\begin{align*}
\lambda_1 = c_1 \wedge - \lambda_1 \geq c_2 \wedge \\
\lambda_2 = c_3 \wedge - 2 \lambda_2 \geq c_4 \wedge \\
c_1 = 3 \lambda_3 \wedge c_3 = 2 \lambda_3 \wedge c_2 + c_4 \geq -10 \lambda_3 \wedge \\
\lambda_1 \geq 0 \wedge \lambda_2 \geq 0 \wedge \lambda_3 \geq 0
\end{align*}

One of the model satisfying the constraint above is

\begin{align*}
\left\lbrace c_1 = 3 \wedge c_2 = -3 \wedge c_3 = 2 \wedge c_4 = -4 \wedge
\lambda_1 = 3 \wedge \lambda_2 = 2 \wedge \lambda_3 = 1 \right\rbrace
\end{align*}
