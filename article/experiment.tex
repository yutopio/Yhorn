...
\begin{figure}
\begin{center}
\includegraphics[scale=1]{figures/int1.eps}\label{fig:int1}
\end{center}
\caption{Interpolation problem}
\end{figure}
...
\begin{figure}[htb]
  ...
  \centering
  \includegraphics[scale=0.8]{figures/int2.eps}
  \label{fig:int2}
  \caption{Complex interpolation problem 2}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{.47\textwidth}
  \centering
  \includegraphics[scale=0.8]{figures/int3.eps}
  \label{fig:int3}
  \caption{Complex interpolation problem 3}
  \end{minipage}
\end{figure}
